...
export const zh = {
  ...
  'card.option.animated': '场景壁纸动图优先',
  'card.option.animatedHint': '默认使用创意工坊的高清预览图（清晰但静止）；开启后改回本地动图（模糊但有动画）',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'card.option.animated': 'Animated scene previews',
  'card.option.animatedHint': 'Default: the sharp Steam workshop preview (static). On: the animated local GIF (blurry but alive)',
